        ...
        <div className="grid gap-10 border-b border-line pb-10 sm:grid-cols-3">
          <div className="sm:col-span-1">
            ...
            <div className="mt-5 space-y-1.5 text-[13px] text-ink-soft">
              ...
              <p>
                <a href="mailto:support@dinezy.in" className="hover:text-accent">
                  support@dinezy.in
                </a>
              </p>
              <p>
                <a href="tel:+917507002369" className="hover:text-accent">
                  +91 75070 02369
                </a>
              </p>
            </div>
          ...
          <div>
            <p className="text-[13px] font-semibold uppercase tracking-wide text-ink">Legal</p>
            <ul className="mt-4 space-y-2.5 text-[13px] text-ink-soft">
              ...
              <li><a href="/refunds" className="hover:text-ink">Refund &amp; Cancellation Policy</a></li>
            </ul>
          </div>

          <div>
            <p className="text-[13px] font-semibold uppercase tracking-wide text-ink">Company</p>
            <ul className="mt-4 space-y-2.5 text-[13px] text-ink-soft">
