  ...
  return (
    <div
      style={{
        ...
        borderRadius: 20,
        border: isInCart
          ? '1px solid rgba(255,92,53,0.25)'
          : '1px solid rgba(232,197,71,0.18)',
        background: isInCart
          ? 'linear-gradient(145deg, rgba(255,92,53,0.07) 0%, #1e1e1e 70%)'
          : 'linear-gradient(145deg, rgba(232,197,71,0.06) 0%, #1e1e1e 70%)',
        overflow: 'hidden',
        position: 'relative',
    ...
    >
      ...
      {/* Image */}
      <div style={{ position: 'relative', width: '100%', height: 110, background: 'rgba(255,255,255,0.04)' }}>
        {imgUrl ? (
        ...
        <div style={{
          ...
          <ChefHat size={9} style={{ color: '#E8C547' }} />
          <span style={{ fontSize: 8, fontWeight: 800, color: '#E8C547', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
            Special
          </span>
        </div>
        ...
        {price && (
          <div style={{ position: 'absolute', bottom: 8, left: 10 }}>
            <span style={{ fontSize: 15, fontWeight: 800, color: '#FAFAF7', letterSpacing: '-0.01em' }}>{price}</span>
          </div>
        )}
      </div>
      ...
      <div style={{ padding: '10px 12px 12px' }}>
        <p style={{
          fontSize: 13, fontWeight: 700, color: '#FAFAF7', margin: 0,
        ...
        {item.description && (
          <p style={{
            fontSize: 10.5, lineHeight: 1.5, color: 'rgba(250,250,247,0.38)',
            margin: '6px 0 0',
            display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden',
          }}>
            ...
            {qtyInCart === 0 ? (
              <button
                ...
                style={{
                  ...
                  border: adding ? '1.5px solid rgba(34,197,94,0.4)' : '1.5px solid rgba(232,197,71,0.4)',
                  background: adding ? 'rgba(34,197,94,0.1)' : 'rgba(232,197,71,0.1)',
                  color: adding ? '#22c55e' : '#E8C547',
              ...
              <div style={{
                ...
                borderRadius: 10, background: '#FF5C35', overflow: 'hidden',
              }}>
                <button type="button" onClick={handleDec}
                  style={{ width: 32, height: '100%', background: 'none', border: 'none', cursor: 'pointer', color: 'white', fontSize: 16, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  −
                </button>
                <span style={{ fontSize: 12, fontWeight: 700, color: 'white', fontFamily: 'var(--font-body)' }}>{qtyInCart}</span>
  ...
  return (
    <div
      style={{
        ...
        background: 'linear-gradient(180deg, rgba(232,197,71,0.04) 0%, #1a1a1a 100%)',
        overflow: 'hidden',
        position: 'relative',
      }}
    >
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
          ...
          <div>
            ...
            <p style={{ margin: '2px 0 0', fontSize: 11, color: 'rgba(250,250,247,0.4)' }}>
