...
export default function Home() {
  return (
    <>
      ...
      <link
        href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,600;1,300;1,400&family=Outfit:wght@300;400;500;600&family=Space+Mono:ital@0;1&display=swap"
        rel="stylesheet"
      />
      ...
      <nav>
        ...
        <a href="#cta" className="nav-cta">Get a Demo →</a>
      </nav>
      ...
      <div className="hero">
        ...
        <div className="hero-actions">
          <a href="#cta" className="btn-primary">Get Your QR Code</a>
              ...
              <div className="phone-screen">
                ...
                <div className="ai-bubble">
                  ...
                  <div className="ai-bubble-text">
                    The{' '}
                    <strong style={{ color: 'var(--gold)' }}>Dal Makhani</strong> pairs perfectly
            ...
            <div className="float-qr">
              <div className="qr-grid">
                {[
                  ...
                  <div key={i} className={`qr-cell ${dark ? 'qr-dark' : 'qr-light'}`} />
                ))}
              </div>
